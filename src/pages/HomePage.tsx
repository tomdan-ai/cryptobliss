...
import { Bitcoin, Feather as Ethereum, DollarSign, BookOpen, TrendingUp, Shield, Globe, Users, Briefcase } from 'lucide-react';
    ...
    <div>
      ...
      <div className="relative">
        <motion.div
          ...
          className="container mx-auto px-4 pt-16 pb-20 text-center"
        >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link to="/about">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="bg-transparent border-2 border-blue-400 hover:border-blue-300 text-white font-bold py-3 px-8 rounded-full text-lg transition-colors duration-300"
              >
                Learn More
              </motion.button>
            </Link>
      ...
      <div className="container mx-auto px-4 py-12">
        <motion.div
          ...
          transition={{ duration: 0.8 }}
          className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 md:p-12"
        >
          <h2 className="text-2xl md:text-3xl font-bold mb-6 text-center">Unlock the Power of Web3</h2>
      ...
      <div className="container mx-auto px-4 py-20">
        ...
        >
          ...
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white font-bold py-3 px-8 rounded-full text-lg transition-all duration-300"
          >
            Get Started Now
          </motion.button>
        </motion.div>
